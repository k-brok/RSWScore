    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    RSWStartDate = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    LSWStartDate = table.Column<DateOnly>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubGroups_Editions_EditionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Criterias_SubCategories_SubCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JurySlots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JurySlots_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JurySlots_SubGroups_SubgroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsYoungest = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    PatrolId = table.Column<Guid>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Scores_Patrols_PatrolId",
                        column: x => x.PatrolId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPL = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsAPL = table.Column<bool>(type: "INTEGER", nullable: false),
                    PatrolId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Scouts_Patrols_PatrolId",
                        column: x => x.PatrolId,
                        principalTable: "Patrols",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Criterias_SubCategoryId",
                table: "Criterias",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JurySlots_CategoryId",
                table: "JurySlots",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_JurySlots_EditionId",
                table: "JurySlots",
                column: "EditionId");

            migrationBuilder.CreateIndex(
                name: "IX_JurySlots_SubgroupId",
                table: "JurySlots",
                column: "SubgroupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Scores_PatrolId",
                table: "Scores",
                column: "PatrolId");

            migrationBuilder.CreateIndex(
                name: "IX_Scouts_PatrolId",
                table: "Scouts",
                column: "PatrolId");
